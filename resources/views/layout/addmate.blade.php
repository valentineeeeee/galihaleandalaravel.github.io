        ...
        <form action="{{ route('material.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" name="material_name" class="form-control" id="exampleInputText1" placeholder="Nama Material">
            </div>
            <div class="form-group">
                <label for="exampleInputPassword1">Harga Material</label> <span style="color: red; font-size:14px;">*Wajib diisi</span>
                <input type="number" name="material_price" class="form-control" id="exampleInputText1" placeholder="Harga Material">
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Stock Material</label> <span style="color: red; font-size:14px;">*Wajib diisi</span>
              <input type="number" name="material_stock" class="form-control" id="exampleInputText1" placeholder="Stock Material">
          </div>
          <div class="form-group">
            <label for="exampleInputPassword1">Waktu Tunggu</label> <span style="color: red; font-size:14px;">*Wajib diisi</span>
            <input type="number" name="material_lt" class="form-control" id="exampleInputText1" placeholder="Lead Time Material">
        </div>
        <div class="form-group">
          <label for="exampleInputPassword1">Waktu Pemesanan Kembali</label> <span style="color: red; font-size:14px;">*Wajib diisi</span>
          <input type="number" name="material_rop" class="form-control" id="exampleInputText1" placeholder="Reorder Point Material">
      </div>
      <div class="form-group">
        <label for="exampleInputPassword1">Material MRP</label> <span style="color: red; font-size:14px;">*Wajib diisi</span>
        <input type="number" name="material_mrp" class="form-control" id="exampleInputText1" placeholder="MRP Material">
    </div>
      <div class="form-group">
        <label for="exampleInputPassword1">Deskripsi Material</label> <span style="color: red; font-size:14px;">*Wajib diisi</span>
        <input type="text" name="material_description" class="form-control" id="exampleInputText1" placeholder="Masukkan Deskripsi">
      </div>
            <div class="form-group">
